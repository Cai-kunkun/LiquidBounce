...
object VelocityIntave : Choice("Intave") {
    ...
    private class ReduceOnAttack(parent: ParentEventListener) : ToggleableConfigurable(
    ...
    private class JumpReset(parent: ParentEventListener) : ToggleableConfigurable(
        parent, "JumpReset",
        true
    ) {
