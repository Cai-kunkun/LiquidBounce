...
class SpeedNCP(override val parent: ChoiceConfigurable<*>) : SpeedBHopBase("NCP", parent) {
    ...
    private inner class PullDown(parent: ParentEventListener?) : ToggleableConfigurable(parent, "PullDown", true) {
    ...
    private inner class Boost(parent: ParentEventListener?) : ToggleableConfigurable(parent, "Boost", true) {
